...
- Web: [Venue.org](https://Venueproject.network)
- Explorer: [explorer.venueproject.network](https://explorer.Venueproject.network)
- Official Mining Pool: [venue.arhash.xyz](http://venue.arhash.xyz)
- Bitcointalk: [Bitcointalk](https://changeme)
- Reddit: [xcash](https://www.reddit.com/r/venueproject/)
- Twitter: [XCashCrypto](https://twitter.com/needschanging/)
- Telegram: [xcashglobal](https://t.me/venueproject)
- Discord: [Venue](https://discord.gg/6DJszs3)
- Medium: [Venue](https://medium.com/Venue)
- GitHub: [https://github.com/Venue-Project/Venue](https://github.com/Venue-Project/Venue)
...
-    Reward: ~100,000 VENU at inception
